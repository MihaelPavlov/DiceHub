...
internal class GetGameListQueryHandler(IGameService gameService, IUserContext userContext, ITenantSettingsCacheService tenantSettingsCacheService, IPushNotificationsService pushNotificationsService) : IRequestHandler<GetGameListQuery, List<GetGameListQueryModel>>
{
    ...
    {
        await this.pushNotificationsService.SendMessageAsync(new ExpiredRewardReminder("Reward", DateTime.UtcNow) { DeviceToken= "c-svnhcnWcwOOVSzVdmO4u:APA91bGhnAs9AyJTfBfyF00l45SSK5l_JpA4ktDkZz77RfbjNCvLqXgTbwDbb0lHG1gxYJHbA5Ak1s0y-MaGodei16OgfkfZbaAooYUqWC9iLNBK2DhrosUY-LO8O_XBTiURtFHrqEAW" });
