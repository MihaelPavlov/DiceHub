...
public class SpaceTableCancelNotification : RenderableNotification
{
    ...
    public override NotificationPayload? Render(ILocalizationService localizer, string userTimeZone, string userLanguage)
    {
        ...
        {
            Title = localizer["SpaceTableCancelledTitle"],
            Body = string.Format(localizer["SpaceTableCancelledBody"], NumberOfGuests, peopleWord, formattedTime)
        };
    }
}
