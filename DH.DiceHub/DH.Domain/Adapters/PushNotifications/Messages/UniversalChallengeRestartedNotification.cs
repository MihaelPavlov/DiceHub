...
public class UniversalChallengeRestartedNotification : RenderableNotification
{
    ...
    public override NotificationPayload? Render(ILocalizationService localizer, string userTimeZone, string userLanguage)
    {
        ...
        {
            Title = localizer["ChallengeRestartedTitle"],
            Body = string.Format(localizer["UniversalChallengeRestartedBody"], challengeName)
        };
    }
}