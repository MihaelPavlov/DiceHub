...
public class GameReservationPublicNoteUpdatedNotification : RenderableNotification
{
    ...
    public override NotificationPayload Render(ILocalizationService localizer, string userTimeZone, string userLanguage)
    {
        ...
        return new NotificationPayload
        {
            ...
            Body = string.Format(localizer["GameReservationNoteChangedBody"], NumberOfGuests, peopleWord, formattedTime)
        };
    }
}