...
public class EventReminderNotification : RenderableNotification
{
    ...
    public override NotificationPayload? Render(ILocalizationService localizer, string userTimeZone, string userLanguage)
    {
        ...
        {
            Title = localizer["EventReminderTitle"],
            Body = string.Format(localizer["EventReminderBody"], EventName, formattedTime)
        };
    }
}
