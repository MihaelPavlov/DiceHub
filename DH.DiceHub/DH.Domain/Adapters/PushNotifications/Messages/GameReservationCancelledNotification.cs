...
public class GameReservationCancelledNotification : RenderableNotification
{
        ...
        string userLanguage)
    {
        ...
        {
            Title = localizer["GameReservationCancelledTitle"],
            Body = string.Format(
                localizer["GameReservationCancelledBody"],
                GameName,
                NumberOfGuests,
                peopleWord,
                formattedTime
